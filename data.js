  ...
  days: [
    {
      ...
      pace: "14:20 落地、取車直接南下乳頭溫泉鄉，不加景點，中途休息 1 次。17:30 前進飯店，第一晚直接在秘湯乾杯。",
      lunch: "機上或機場簡單吃，途中休息站補一餐。",
      dinner: "飯店晚餐（已含）。晚餐後泡湯，宵夜有免費擔擔麵。",
      rainPlan: "班機延誤就全程以進飯店為目標，取消中途停留。",
      spots: [
        { name: "青森機場", q: "青森空港" },
    ...
    },
    {
      ...
      pace: "上午乳頭溫泉鄉（鶴之湯）泡湯，下午環田澤湖一圈（辰子像、湖畔咖啡）。",
      lunch: "田澤湖湖畔咖啡或簡餐（ORAE）。",
      dinner: "飯店晚餐（已含）。早點回飯店泡湯，不排男鹿半島。",
      rainPlan: "下雨改室內泡湯與湖畔咖啡；天氣佳走湖景、露天風呂與環湖。",
      spots: [
        { name: "鶴之湯溫泉", q: "鶴の湯温泉" },
    ...
    },
    {
      ...
      pace: "上午退房離開溫泉鄉。角館武家屋敷散策 1.5–2h，午餐後進盛岡，15:00 入住。",
      lunch: "角館吃比內地雞、稻庭烏龍或在地定食。",
      dinner: "盛岡市區自理。步行吃『冷麵 + 燒肉』，再接第二攤居酒屋。",
      rainPlan: "下雨幾乎不受影響，本就是移動加城市夜生活日。",
      spots: [
    ...
    },
    {
      ...
      pace: "全程最長單日往返，龍泉洞或淨土之濱二選一。09:00 出發、午後回程、17:00 前回盛岡吃燒肉冷麵。",
      lunch: "龍泉洞或宮古海邊吃海鮮丼、烤魚、蕎麥、定食。",
      dinner: "盛岡市區自理。換一家居酒屋或燒肉，兩晚口味有變化。",
      rainPlan: "大雨或海邊風大，改走龍泉洞（洞窟不受雨影響）或盛岡市區慢遊 + 岩手縣立美術館。",
      spots: [
        { name: "龍泉洞", q: "龍泉洞" },
        { name: "淨土之濱", q: "浄土ヶ浜" },
    ...
    },
    {
      ...
      pace: "09:30 出發。美術館停留 1.5–2h，15:00 入住星野，留飯店設施時間。",
      lunch: "十和田市現代美術館周邊簡餐或咖啡。",
      dinner: "飯店晚餐（已含）。前後泡湯、逛大廳、喝一杯。",
      rainPlan: "下雨無妨，美術館 + 飯店幾乎不受影響。",
      spots: [
    ...
    },
    {
      ...
      pace: "上午走一段奧入瀨溪流步道 1–2h（6 月新綠），下午十和田湖遊船，其餘交給咖啡、泡湯、發呆。",
      lunch: "飯店內或十和田湖周邊簡單吃。",
      dinner: "飯店晚餐（已含）。晚上喝酒聊天。",
      rainPlan: "小雨無妨；雨勢大改短距離散步 + 飯店設施，遊船遇強風可能停航，現場確認。",
      spots: [
    ...
    },
    {
      ...
      pace: "10:00 離開奧入瀨。弘前排城跡、公園前星巴克與午餐，不塞太滿。",
      lunch: "弘前市區洋食、蘋果系餐點、咖啡輕食。",
      dinner: "青森市區自理。入住後用 SPA，晚上找海鮮或居酒屋。",
      rainPlan: "下雨弘前仍保留，改洋館散步、咖啡與市區短停留。",
      spots: [
        { name: "弘前城", q: "弘前城" },
    ...
    },
    {
      ...
      pace: "05:00 出門、06:30 抵達。朝市逛 1.5–2h，回青森後下午放慢。",
      lunch: "早餐在八戶朝市解決，中午青森站周邊補輕食。",
      dinner: "青森市區自理。找車站附近居酒屋，不排高難度餐廳。",
      rainPlan: "大雨朝市體驗下降，改青森市區睡魔之家 + A-FACTORY + 咖啡。",
      spots: [
    ...
    },
    {
      ...
      pace: "早餐吃飯店，時間充裕再去青森縣立美術館；13:30 前完成還車。",
      lunch: "機場或機上解決。",
      dinner: "—",
      rainPlan: "可省略美術館，市區補貨後去機場。",
      spots: [
